function CGame(oData, iLevel /* mat */) {
    var _bStartGame;
    var _bBlockMovement;
    var _bBlockKeyboard;
    var _bFrogOnSupport;
    ...
    this._init = function(iLevel /* mat */){
        ...
        if(s_bMobile){
            s_oCanvas.addEventListener("touchend", s_oGame.onUpPress, false);
        } else{   
            s_oStage.on("click", function(){s_oGame.onUpPress();});
        }
    ...
    this.unload = function(){
        ...
        if(s_bMobile){
            ...
            s_oStage.off("pressup", function(){s_oGame.onUpPress();});
        }
