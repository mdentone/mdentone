function CGame(oData) {
    ...
    this.gameOver = function(levelPassed /* mat */){  
        if(_bExit){
            return;
        }
	
        _bUpdate=false;
        $(s_oMain).trigger("end_level", levelPassed /* mat */);
        if(DISABLE_SOUND_MOBILE === false || s_bMobile === false){
            var oParent = this;
    ...
    this.onExit = function(){
        ...
        $(s_oMain).trigger("end_level", false);
