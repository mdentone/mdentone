function CLevelMenu(){
	...
	_oContainer.addChild(oBg);
        ...
        _pStartPosSelect = {x:CANVAS_WIDTH/2,y:380};
        _oTextLevelBack = new createjs.Text(TEXT_SELECT_LEVEL ,"50px "+FONT_GAME, "#000");
        _oTextLevelBack.x = _pStartPosSelect.x + 2;
        _oTextLevelBack.y = _pStartPosSelect.y + 2;
        _oTextLevelBack.textAlign = "center";
        s_oStage.addChild(_oTextLevelBack);
